...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Highlight.date_created'
        db.add_column('posts_highlight', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 4, 27, 0, 0), blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Highlight.date_created'
        db.delete_column('posts_highlight', 'date_created')
