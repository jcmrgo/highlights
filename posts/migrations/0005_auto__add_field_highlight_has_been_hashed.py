...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Highlight.has_been_hashed'
        db.add_column('posts_highlight', 'has_been_hashed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Highlight.has_been_hashed'
        db.delete_column('posts_highlight', 'has_been_hashed')
    ...
    models = {
        ...
        'posts.highlight': {
            ...
            'emotion': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'has_been_hashed': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
